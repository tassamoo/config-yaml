# 1. You are designing an ecommerce web application that will scale to hundreds of thousand of concurrent users. What database technology is best suited to hold session state?
amazon dynamoDB
